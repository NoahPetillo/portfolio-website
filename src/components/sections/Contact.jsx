...
const links = [
  {
    ...
    display: 'github.com/NoahPetillo',
  },
  {
    label: 'LinkedIn',
    ...
    display: 'linkedin.com/in/noah-petillo',
  },
  {
    label: 'Email',
    href: 'mailto:noahpetillo@gmail.com',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
      </svg>
    ),
    display: 'noahpetillo@gmail.com',
  },
]
    ...
    <SectionWrapper id="contact" className="bg-surface/30">
      <div className="max-w-xl">
        ...
        <p className="text-secondary leading-relaxed mb-10">
          Whether you have a question, an opportunity, or just want to talk ML, I&apos;d love to
          connect.
        </p>
        ...
        <div className="space-y-4 mb-10">
          {links.map(({ label, href, icon, display }) => (
            <a
              ...
              className="flex items-center gap-4 p-4 rounded-lg bg-surface border border-border hover:border-accent/50 hover:text-accent-hover transition-all duration-200 group"
            >
